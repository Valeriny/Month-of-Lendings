...
function left() {
  ...
  for (let i = 0; i < sliders2.length; i++) {
    ...
    if (sliders2[i].src === "http://127.0.0.1:5505/images/highway.jpg") {
      sliderVector.src = "images/Vector 1.svg";
    } else if (sliders2[i].src === "http://127.0.0.1:5505/images/gravel.jpg") {
...
function switchTheme() {
  ...
  trainingSubtitle.classList.toggle("traning__subtitle_theme_dark");
  ...
  footerFormButton.classList.toggle("footer__form-button__theme_dark");
  ...
  for (let i = 0; i < trainingLink.length; i++) {
    trainingLink[i].classList.toggle("traning__link_theme_dark");
  }
